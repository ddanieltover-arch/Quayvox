...
const Home = () => (
  <>
    ...
    <section className="relative w-full py-16 lg:py-24 px-4 sm:px-6 lg:px-8 xl:px-12">
      ...
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.06}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {highlights.map((item) => (
            <div key={item.title} data-reveal-item className="card-surface card-interactive p-6">
    ...
    <section className="relative w-full py-16 lg:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-white/5">
      ...
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.06}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {steps.map((item) => (
            <div key={item.step} data-reveal-item className="relative">
    ...
    <section className="relative w-full py-16 lg:py-24 px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-white/5">
      ...
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.055}>
    ...
    <section className="relative w-full py-16 lg:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-white/5">
      ...
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.05}>
      ...
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.06}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quotes.map((q) => (
            <div key={q.quote} data-reveal-item className="card-surface card-interactive p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {pricingTeasers.map((plan) => (
            <div
              key={plan.name}
              data-reveal-item
              className={`card-surface card-interactive p-6 flex flex-col ${
    ...
    {/* Contact CTA */}
    <section className="relative w-full py-16 lg:py-24 px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-white/5">
      <Reveal staggerSelector="[data-reveal-item]" stagger={0.08}>
